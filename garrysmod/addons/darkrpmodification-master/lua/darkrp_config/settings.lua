...
GM.Config.mprintamount                  = 60
-- normalsalary - Sets the starting salary for newly joined players.
GM.Config.normalsalary                  = 2
-- npckillpay - Sets the money given for each NPC kill.
GM.Config.npckillpay                    = 3
...
GM.Config.CategoryOverride = {
    jobs = {
        ...
        ["Бандит"]                              = "Громадяни",
        ["Лояліст I рівня"]                     = "Громадяни",
        ["Лояліст II рівня"]                    = "Громадяни",
        ["Лояліст III рівня"]                   = "Громадяни",
        ["Міський адміністратор"]               = "Громадяни",
        ["Наглядач жилого блоку"]               = "ГСП",
        ["Кухар"]                               = "ГСП",
        ["Різнороб"]                            = "ГСП",
        ["Поштар"]                              = "ГСП",
        ["Секретар"]                            = "ГСП",
        ...
        ["Медик"]                               = "Біженці",
        ["Зброяр"]                              = "Біженці",
        ["Контрабандист"]                       = "Біженці",
        ["Сміттяр"]                             = "Біженці",
        ["Виживший"]                            = "Біженці",
        ["Вортігонт (VIP)"]                     = "Біженці",
        ["MPF.RCT"]                             = "ЦО",
        ["MPF.PATROL.05"]                       = "ЦО",
        ["MPF.PATROL.04"]                       = "ЦО",
        ["MPF.PATROL.03"]                       = "ЦО",
        ["MPF.PATROL.02"]                       = "ЦО",
        ["MPF.PATROL.01"]                       = "ЦО",
        ["MPF.SPEC.SNIPER (VIP)"]               = "ЦО",
        ["MPF.SPEC.JAGGER (VIP)"]               = "ЦО",
        ["MPF.SPEC.OFC"]                        = "ЦО",
        ["MPF.SPEC.SEC"]                        = "ЦО",
        ["MPF.CMD.DIS"]                         = "ЦО",
